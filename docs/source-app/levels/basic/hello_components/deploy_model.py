...
from lightning.app.components.serve import Image, Number, PythonServer
...
component = PyTorchServer(input_type=Image, output_type=Number, cloud_compute=CloudCompute("gpu"))
