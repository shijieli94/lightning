...
from lightning.fabric.loggers.logger import (
    _DummyExperiment as DummyExperiment,  # for backward compatibility
)
from lightning.fabric.loggers.logger import (  # noqa: F401  # for backward compatibility
