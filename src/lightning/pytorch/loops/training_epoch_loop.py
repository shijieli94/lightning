...
from lightning.pytorch.loops.optimization import (
    _AutomaticOptimization,
    _ManualOptimization,
)
from lightning.pytorch.loops.optimization.automatic import (
    _OUTPUTS_TYPE as _OPTIMIZER_LOOP_OUTPUTS_TYPE,
)
from lightning.pytorch.loops.optimization.manual import (
    _OUTPUTS_TYPE as _MANUAL_LOOP_OUTPUTS_TYPE,
)
